...
public class VoidTokenItem extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_token")
	public static final Item block = null;
	public VoidTokenItem(DiamantinocraftModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used in teleporter to teleport in the void."));
		}
	}
}

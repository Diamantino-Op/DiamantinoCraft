...
public class NetherTokenItem extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:nether_token")
	public static final Item block = null;
	public NetherTokenItem(DiamantinocraftModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used in teleporter to teleport in the nether."));
		}
	}
}

...
public class WirePlacedProcedure extends DiamantinocraftModElements.ModElement {
	public WirePlacedProcedure(DiamantinocraftModElements instance) {
		super(instance, 66);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				DiamantinocraftMod.LOGGER.warn("Failed to load dependency x for procedure WirePlaced!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				DiamantinocraftMod.LOGGER.warn("Failed to load dependency y for procedure WirePlaced!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				DiamantinocraftMod.LOGGER.warn("Failed to load dependency z for procedure WirePlaced!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				DiamantinocraftMod.LOGGER.warn("Failed to load dependency world for procedure WirePlaced!");
			return;
		}
		...
		if (!world.isRemote()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("energyMax", 8);
			if (world instanceof World)
				((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
		}

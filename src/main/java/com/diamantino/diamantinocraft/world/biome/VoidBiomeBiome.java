...
package com.diamantino.diamantinocraft.world.biome;
...
import com.diamantino.diamantinocraft.block.VoidDirtBlock;
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(VoidGrassBlock.block.getDefaultState(),
								VoidDirtBlock.block.getDefaultState(), VoidDirtBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(VoidPackLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(VoidPackLeavesBlock.block.getDefaultState()),
								new JungleFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 2),
								new MegaJungleTrunkPlacer(16, 2, 19), new TwoLayerFeature(1, 1, 2)))
				...
				event.getRegistry().register(biome.setRegistryName("diamantinocraft:void_biome"));
			}
		}
	}
	@Override

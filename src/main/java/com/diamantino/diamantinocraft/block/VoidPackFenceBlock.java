...
public class VoidPackFenceBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_fence")
	public static final Block block = null;
	public VoidPackFenceBlock(DiamantinocraftModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("void_pack_fence");
		}

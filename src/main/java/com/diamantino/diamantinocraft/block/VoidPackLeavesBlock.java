...
public class VoidPackLeavesBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_leaves")
	public static final Block block = null;
	public VoidPackLeavesBlock(DiamantinocraftModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("void_pack_leaves");
		}

...
public class BaseWireCon2AngleBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:base_wire_con_2_angle")
	public static final Block block = null;
	@ObjectHolder("diamantinocraft:base_wire_con_2_angle")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BaseWireCon2AngleBlock(DiamantinocraftModElements instance) {
		super(instance, 31);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("base_wire_con_2_angle"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("base_wire_con_2_angle");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("base_wire_con_2_angle");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Base Wire Con 2 Angle");
		}

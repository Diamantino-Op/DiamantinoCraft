...
public class VoidStoneBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_stone")
	public static final Block block = null;
	public VoidStoneBlock(DiamantinocraftModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(VoidCobblestoneBlock.block, (int) (1)));
		}
	}
}

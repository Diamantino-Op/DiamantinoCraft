...
public class SolarPanelT1Block extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:solar_panel_t_1")
	public static final Block block = null;
	@ObjectHolder("diamantinocraft:solar_panel_t_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanelT1Block(DiamantinocraftModElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SolarPanelT1GenerateEnergyProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(100000, 10, 100, 0) {
			@Override

...
public class VoidPackSlabBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_slab")
	public static final Block block = null;
	public VoidPackSlabBlock(DiamantinocraftModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("void_pack_slab");
		}

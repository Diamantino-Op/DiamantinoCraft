...
public class VoidPackLogBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_log")
	public static final Block block = null;
	public VoidPackLogBlock(DiamantinocraftModElements instance) {
		super(instance, 12);
	}

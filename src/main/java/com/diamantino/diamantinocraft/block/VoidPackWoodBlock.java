...
public class VoidPackWoodBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_wood")
	public static final Block block = null;
	public VoidPackWoodBlock(DiamantinocraftModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("void_pack_wood");
		}

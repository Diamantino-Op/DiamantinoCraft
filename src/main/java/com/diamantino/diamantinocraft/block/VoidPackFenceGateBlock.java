...
public class VoidPackFenceGateBlock extends DiamantinocraftModElements.ModElement {
	@ObjectHolder("diamantinocraft:void_pack_fence_gate")
	public static final Block block = null;
	public VoidPackFenceGateBlock(DiamantinocraftModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("void_pack_fence_gate");
		}
